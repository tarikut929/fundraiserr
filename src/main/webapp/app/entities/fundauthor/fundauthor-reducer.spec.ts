...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNDAUTHOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_FUNDAUTHOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FUNDAUTHOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FUNDAUTHOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FUNDAUTHOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FUNDAUTHOR actions', async () => {
      const expectedActions = [
        {
